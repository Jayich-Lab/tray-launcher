...
from win32con import STILL_ACTIVE, PROCESS_QUERY_INFORMATION, SW_RESTORE, HWND_NOTOPMOST, HWND_TOPMOST, SWP_NOMOVE, SWP_NOSIZE, SWP_SHOWWINDOW
...
class ChildScript():  
    ...
    def start_script(self):
        ...
        try:
            ...
            raise
        self.childScript = Popen(self.script_path_str, encoding = self.ENCODING, stdout = self.outputs_file, stderr = self.outputs_file, shell = True)  
