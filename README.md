...
To start the *tray launcher*, first make sure you are in the Python environment variable where *launcher run* is installed. Then, running `tray-launcher` will show a small icon in the taskbar.
