...
class LauncherTray (QMainWindow):
    ...
    def load_script(self, script_path_str):
        ...
        if(not isDuplicateName):
            ...
            replace_reply = b.question(self, "Replace File (Tray Launcher)", "A file named {} already exists in the directory {}. Do you want to replace it?".format(name, self.AVAILABLE_SCRIPTS), 
